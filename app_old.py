                ...
                try:
                    ...
                    if not all([sender_email, sender_password, admin_email]):
                        ...
                        **For Administrator:** Please configure the following environment variables:
                        ...
                        if file_format == "CSV":
                            ...
                            with pd.ExcelWriter(buffer, engine="openpyxl") as writer:
                                df_download.to_excel(
                                    writer, index=False, sheet_name="Complexity Index"
                                )
                        ...
                        msg_user["Subject"] = (
                            "Institutional Complexity Index - Data Download"
                        )
...
- Countries: {"All" if not download_countries else ", ".join(download_countries)}
...
"""
                        ...
                        msg_admin["Subject"] = (
                            f"New Data Download Request - {user_name}"
                        )
...
"""
                    ...
                    # Fallback: show download buttons
                    st.markdown("---")
